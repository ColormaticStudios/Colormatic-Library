+++
title = "Colormatic In-Text Citation Format"
date = 2025-05-24
draft = false
layout = "resource"
+++

When citing documents in a research paper, news article, etc. there are many ways to do so. Popular formats include MLA and APA citation. Here at Colormatic Studios we have our own in-text citation format, and it’s simply called CCF (++C++olormatic ++C++itation ++F++ormat). The goal is to be easy to understand and effective at referencing other work and can be used for listing sources, references, etc. This document will show you how to use it properly.

<!--more-->

To start, here is a template that you can take and fill in for your citations:

First Last, First Last & First Last, publisher:*section*. (Pub.|Upd.|© ++DATE++) *“Title”* [Link type](https://example.org)|++Page++ Retrieved: ++DATE++.
...
1. APA Style:*Style and Grammar Guidelines.* (Upd. ++July 2022++) *"Basic Principles of Citation"* [Web](https://apastyle.apa.org/style-grammar-guidelines/citations/basic-principles). Retrieved: ++11/19/2024++.
2. MLA Style Center:*Works-Cited-List Entries.* *"How to Cite an Online Work"* [Web.](https://style.mla.org/works-cited/citations-by-format/online-works/) Retrieved: ++11/19/2024++.
...
For languages that don't use the Latin alphabet, either use the local ordering rules or the order found in Unicode. This is something that the APA style doesn't cover very well.^1^
